function English() {
  const LetEn = [
    "He who said to God from the fire.",

    "He did not hurt him from God.",

    "Who said to God, what is the most important thing of the world and the hereafter.",

    "Who said when he becomes and when he is prisoning him from everything (sincerity and sincerity).",

    "Who said when he became ahead of his day.",

    "Who said when he becomes and when he was really in God to satisfy him on the Day of Resurrection.",

    "Who said when he becomes and when he is prisoning him from everything (sincerity and sincerity).",

    "Who said to be our time when he laes and died of his night income of Paradise as well as when it becomes.",

    "One hundred good, greeted him 100 bad, and had a confusion of the devil until he was prison.",
    ...
    "Whoever prays when he becomes and when I realize my story on the Day of Resurrection.",

    "Stei ang See version of the megness.PRandentology (r) minated ammantal",
    ...
    "Who said when he was forced to thank his day.",

    "Who said when he becomes and when he was really in God to satisfy him on the Day of Resurrection.",

    "Who said when he becomes a wage from the jinn until I prison and he said when he walks from the jinn until he becomes.",

    "From reading Ayatin from the last Surah Al-Baqarah at the night of Kuffah.",

    "If he said, Devil said: Save me other today",
    ...
    "I am pleased with Allah as my Lord, with Islām as my religion and with Muhammad ﷺ as my Prophet.",
    ...
    "When My servants ask you about Me, indeed I am near. I respond to the invocation of the supplicant when he calls upon Me. So let them obey Me, and believe in Me that they may be guided.",
  ...
  return LetEn[Math.floor(Math.random() * LetEn.length)];
}
